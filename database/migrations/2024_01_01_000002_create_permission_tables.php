...
return new class extends Migration
{
    public function up()
    {
        ...
        Schema::create($tableNames['role_has_permissions'], function (Blueprint $table) use ($tableNames, $teams, $columnNames) {
            $table->unsignedBigInteger('permission_id');
            $table->unsignedBigInteger('role_id');
            ...
            if ($teams) {
                ...
                $table->primary([$columnNames['team_foreign_key'], 'permission_id', 'role_id'], 'role_has_permissions_permission_id_role_id_primary');
            } else {
